 ...
 *   Upstream: nrf/samples/cellular/gnss/src/assistance_supl.c
 *   Local   : C:/ncs/v3.4.0/nrf/samples/cellular/gnss/src/assistance_supl.c
 *   Copiado : 2026-09-08 — curso nrf-manaus-2, modulo gnss/01_nrf9151_basic
 *
 * Para conferir se divergiu do SDK:
 *   diff <este arquivo> C:/ncs/v3.4.0/nrf/samples/cellular/gnss/src/assistance_supl.c
 *
