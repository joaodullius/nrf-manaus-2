 ...
 *   Upstream: nrf/samples/wifi/ble_coex/src/main.c
 *   Local   : C:/ncs/v3.4.0/nrf/samples/wifi/ble_coex/src/main.c
 *   Copiado : 2026-09-06 - curso nrf-manaus-2, modulo comms/12_wifi_coex
 *
