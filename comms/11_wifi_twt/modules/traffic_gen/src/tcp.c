 ...
 *   Upstream: nrf/samples/wifi/twt/modules/traffic_gen/src/tcp.c
 *   Local   : C:/ncs/v3.4.0/nrf/samples/wifi/twt/modules/traffic_gen/src/tcp.c
 *   Copiado : 2026-09-06 — curso nrf-manaus-2, modulo comms/11_wifi_twt
 *
 * Para conferir se divergiu do SDK:
 *   diff <este arquivo> C:/ncs/v3.4.0/nrf/samples/wifi/twt/modules/traffic_gen/src/tcp.c
 *
