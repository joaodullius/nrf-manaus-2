...
| [`11_wifi_twt/`](11_wifi_twt/) | **Wi-Fi 11** — A escada de economia de energia: DTIM e listen interval medidos por latência com o firmware do lab 6 (Parte A, Passo 1) e preparados para medida de corrente com PPK2 (Parte A, Passo 2, pendente da decisão do instrutor sobre o solder bridge da EB II); TWT (Parte B) depende de um AP que negocie | nRF54LM20-DK + nRF7002-EBII | ✅ (Passo 2 e Parte B pendentes) |
