 ...
 *   Upstream: nrf/samples/wifi/provisioning/ble/src/main.c
 *   Local   : C:/ncs/v3.4.0/nrf/samples/wifi/provisioning/ble/src/main.c
 *   Copiado : 2026-09-07 — curso nrf-manaus-2, modulo comms/08b_wifi_provisioning_ble
 *
 * Para conferir se divergiu do SDK:
 *   diff <este arquivo> C:/ncs/v3.4.0/nrf/samples/wifi/provisioning/ble/src/main.c
 *
