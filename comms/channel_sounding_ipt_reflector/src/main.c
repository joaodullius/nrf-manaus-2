 ...
 *   Upstream: nrf/samples/bluetooth/channel_sounding/ipt_reflector/src/main.c
 *   Local   : C:/ncs/v3.4.0/nrf/samples/bluetooth/channel_sounding/ipt_reflector/src/main.c
 *   Copiado : 2026-09-05 — curso nrf-manaus-2, modulo comms/channel_sounding_ipt_reflector
 *
 * Para conferir se divergiu do SDK:
 *   diff <este arquivo> C:/ncs/v3.4.0/nrf/samples/bluetooth/channel_sounding/ipt_reflector/src/main.c
 *
