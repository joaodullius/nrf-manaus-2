 ...
 *   Copiado : 2026-09-05 — curso nrf-manaus-2, modulo comms/05_cs_iq_music
 ...
 *      digitado no terminal serial no boot (src/lab_tag_addr.c), modo AND. Mesmo
 *      codigo do comms/02_cs_initiator.
