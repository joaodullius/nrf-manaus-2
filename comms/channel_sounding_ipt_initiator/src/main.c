 ...
 *   Copiado : 2026-09-05 — curso nrf-manaus-2, modulo comms/channel_sounding_ipt_initiator
 *
 ...
 *      esse nome. Aqui entra o filtro pelo endereco de CONFIG_LAB_TAG_ADDR_VALUE
 *      e o modo passa a AND.
