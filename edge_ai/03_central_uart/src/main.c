 ...
 *   Upstream: nrf/samples/bluetooth/central_uart/src/main.c
 *   Local   : C:/ncs/v3.4.0/nrf/samples/bluetooth/central_uart/src/main.c
 *   Copiado : 2026-08-30 — curso nrf-manaus-2, modulo edge_ai/03_central_uart
 *
 ...
 *
 * Upstream: o filtro de endereco era alimentado pelos bonds (bt_foreach_bond) e
 * combinado com o filtro de UUID em modo OR (bt_scan_filter_enable(..., false)) —
...
static int scan_start(void)
{
	...
	/* match_all = true: so conecta no endereco configurado. */
