...
| [`11_benchmark_npu_vs_cpu/`](11_benchmark_npu_vs_cpu/) | O **mesmo modelo** do Lab nos dois backends (troca por Kconfig, zero mudanca no app): latencia medida por inferencia. Resultado honesto: modelo pequeno → CPU ganha (229 vs 332 µs); NPU escala para os grandes | nRF54LM20-DK | ✅ completo: latencia, energia (PPK2) e formas de onda medidas |
