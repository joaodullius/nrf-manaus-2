...
| [`05_gesture_led/`](05_gesture_led/) | App minima: IMU → inferencia → LED RGB. Onde o modelo proprio do aluno entra. Vem com o modelo de exemplo da Nordic como andaime | nRF54L15-TAG | ✅ compilado e rodando |
