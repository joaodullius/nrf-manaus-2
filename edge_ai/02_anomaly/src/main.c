 ...
 *   Upstream: samples/nrf_edgeai/anomaly/src/main.c
 *   Local   : C:/ncs/sdk-edge-ai/edge-ai/samples/nrf_edgeai/anomaly/src/main.c
 *   Copiado : 2026-08-29 — curso nrf-manaus-2, modulo edge_ai/02_anomaly
 *
 * Para conferir se divergiu do SDK:
 *   diff <este arquivo> C:/ncs/sdk-edge-ai/edge-ai/samples/nrf_edgeai/anomaly/src/main.c
 */
