 ...
 *   Upstream: applications/ww_kws/src/main.c
 *   Local   : C:/ncs/sdk-edge-ai/edge-ai/applications/ww_kws/src/main.c
 *   Copiado : 2026-09-04 — curso nrf-manaus-2, modulo edge_ai/06_ww_kws
 *
 * Para conferir se divergiu do SDK:
 *   diff <este arquivo> C:/ncs/sdk-edge-ai/edge-ai/applications/ww_kws/src/main.c
 */
/*
